...
-- 5.Do subscribed customers spend more?compare average spend total revenue between subscribers and non-subscribers?
...
-- 7. segment customers into new,returning and loyal based on their total number of pervious purchases and show the count of each segment
